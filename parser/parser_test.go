...
import (
	...
	"github.com/wednesdaysunny/goswgspecgen/parser"
	"go/ast"
	//	"log"
	"os"
	"path"
...
func (suite *ParserSuite) SetupSuite() {
	if initialisedParser2 == nil {
		...
		initialisedParser2.ParseGeneralApiInfo(path.Join(gopath, "src", "github.com/wednesdaysunny/goswgspecgen/example/web/main.go"))
		initialisedParser2.ParseApi("github.com/wednesdaysunny/goswgspecgen/example")
	}
